...
response9 = Response.create(question_id: question3.id, answer_type: "text", student_id: 6, course_id: 2)
response10 = Response.create(question_id: question3.id, answer_type: "text", student_id: 7, course_id: 2)
